class SecureWallet {
    constructor() {
        ...
        this.sendCode = null;
        this.sendCodeExpiry = null; // timestamp
...
// If we reach here, code is valid – optionally clear it
this.sendCode = null;
this.sendCodeExpiry = null;
