...
/* VERTICAL DASHBOARD LAYOUT - Add this to the end of your existing style.css */

/* Dashboard main container - vertical stack */
.dashboard-main {
    display: flex;
    flex-direction: column;
    gap: 24px;
...
/* All dashboard sections full width */
.dashboard-left,
.dashboard-right {
    width: 100%;
}
...
/* Make dashboard screen full width */
#dashboard-screen {
    width: 100%;
    max-width: none;
}
